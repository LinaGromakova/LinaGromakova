...
*  **Frontend Developer** with a passion for building clean, fast, and interactive web applications.
*  **Current Focus:** Deepening my Fullstack skills using Supabase, PostgreSQL, and real-time backend logic.
*  **Architecture:** Practicing **Feature-Sliced Design (FSD)** and modular approaches to write scalable code.
